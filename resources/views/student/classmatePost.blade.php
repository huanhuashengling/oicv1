    ...
    @foreach(@$posts as $key=>$post)
        ...
        <div class="col">
            <div class="card h-100 {{$cardCss}}"><!-- style="padding-left: 5px; padding-right: 5px;"    col-sm-3 col-xs-4-->
                ...
                <a href="/student/sb3player?postCode={{$post->post_code}}" style="padding: 5px;"><img class="card-img-top" src="{{ getThumbnail($post->post_code . '.' . $post->cover_ext, 320, 230, $schoolCode, 'fit', $post->cover_ext) }}" value="{{ $post['pid'] }}" alt="Card image cap"></a>
